                ...
                <div className="md:flex md:justify-between">
                    <div className="mb-10 md:mb-0">
                        ...
                        <p className={`dark:text-gray-400 text-gray-600 text-sm max-w-sm pt-1`}>
                            Do not send your bugs to this email, please use our <Link href="/user/report-issue" className="dark:text-blue-500 text-blue-700">issue tracker</Link> instead.
                        </p>
                    </div>
          ...
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">{getCopyrightText()} <Link
              href="/" className="hover:underline md:dark:hover:text-gray-500">MohistMC</Link>
                    ...
                    <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <Link href="https://twitter.com/mohistmc" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                        ...
                        <Link href="https://github.com/MohistMC/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <Link href="https://discord.gg/mohistmc" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
