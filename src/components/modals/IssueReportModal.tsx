        ...
        <Flowbite theme={{ theme: customTheme, mode }}>
            ...
            >
                ...
                <Modal.Body>
                        ...
                        >
                            ...
                            <Dropdown.Item>
                                ...
                                >
                                    {
                                        strings[
                                            'issuemodal.dropdown.item.website'
                                        ]
                                    }
                                </Link>
                                <HiExternalLink className="ml-2 h-5 w-5" />
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-200 text-center mt-5">
                        {strings['issuemodal.discord.text']}
                    </p>
                    <div
                        className={`flex flex-row gap-2 justify-center align-center mt-3`}
                    >
                ...
                <Modal.Footer>
                    <Button
                        color="gray"
                        onClick={() => setOpenIssueModal(undefined)}
                    >
