    ...
    return (
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 flex flex-row gap-4 flex-wrap">
            <button onClick={() => setSelectedIssueType('bug')} aria-label="Report a bug"
                ...
                <p className="font-normal text-gray-700 dark:text-gray-400">You have bugs with one of our software? Click on this card.</p>
            </button>
            ...
            <button onClick={() => setSelectedIssueType('feature')} aria-label="Request a feature"
                ...
                <p className="font-normal text-gray-700 dark:text-gray-400">You want to make our software better? Click on this card.</p>
            </button>
            ...
            <button onClick={() => setSelectedIssueType('question')} aria-label="Ask a question"
                ...
                <p className="font-normal text-gray-700 dark:text-gray-400">Any question about? Click on this card.</p>
            </button>
            ...
            <button onClick={() => setSelectedIssueType('other')} aria-label="Other"
                ...
                <p className="font-normal text-gray-700 dark:text-gray-400">If you don&apos;t see what you want to do above, click on this card.</p>
            </button>
        </div>
    )
}
