const enTranslation= {
    ...
    strings: {
        ...
        "index.cards.mohistneo.description": "A powerful Mohist NeoForge hybrid server software implementing Bukkit, Spigot and Paper APIs.",
        ...
        "software.mohistneo.subtitle": "MohistNeo is an exceptional server software for NeoForge that implements Bukkit, Spigot, and Paper APIs. By leveraging this powerful combination, you can create a high-performing Minecraft server with the ability to integrate mods and plugins, ensuring stability and optimal performance.",
        "software.mohistneo.cards.title": "What makes %MohistNeo% so special?",
        "software.mohistneo.cards.1.title": "Enhanced Performance",
        "software.mohistneo.cards.1.desc": "With the integration of Bukkit & Spigot for plugin support and Paper for performance, enjoy a smooth and seamless gaming experience, even with a multitude of mods and plugins.",
        "software.mohistneo.cards.2.title": "Compatibility",
        "software.mohistneo.cards.2.desc": "Unlock endless possibilities with MohistNeo extensive mod and plugin compatibility. Customize your server effortlessly using MohistNeo integration with Bukkit, Spigot, and Paper APIs.",
