const enTranslation= {
    ...
    strings: {
        ...
        "index.cards.mohistneo.description": "A powerful Mohist NeoForge hybrid server software implementing Bukkit, Spigot APIs.",
        ...
        "software.mohistneo.page.title": "MohistMC - MohistNeo",
        "software.mohistneo.title": "MohistNeo - Coming soon",
        "software.mohistneo.subtitle": "MohistNeo is an exceptional server software for NeoForge that implements Bukkit, Spigot APIs. By leveraging this powerful combination, you can create a high-performing Minecraft server with the ability to integrate mods and plugins, ensuring stability and optimal performance.",
        "software.mohistneo.cards.title": "What makes %MohistNeo% so special?",
        "software.mohistneo.cards.1.title": "Enhanced Performance",
        "software.mohistneo.cards.1.desc": "With the integration of Bukkit & Spigot for plugin support and performance, enjoy a smooth and seamless gaming experience, even with a multitude of mods and plugins.",
        "software.mohistneo.cards.2.title": "Compatibility",
        "software.mohistneo.cards.2.desc": "Unlock endless possibilities with MohistNeo extensive mod and plugin compatibility. Customize your server effortlessly using MohistNeo integration with Bukkit, Spigot APIs.",
        "software.mohistneo.cards.3.title": "Community Support and Regular Updates",
        "software.mohistneo.cards.3.desc": "Join the MohistMC community for support and regular updates! Stay up-to-date with the latest Minecraft versions and access new features and improvements.",
        "software.mohistneo.footer.title": "Ready to level up your Minecraft server experience?",
        "software.mohistneo.footer.desc": "Experience unparalleled stability with mod & plugin integration, and optimized performance. Join the MohistMC community and unlock limitless possibilities for your server. Upgrade to MohistNeo today and revolutionize your Minecraft experience.",
        "software.mohistneo.footer.discord": "Join our Discord",
