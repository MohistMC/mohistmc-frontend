...
const zhTranslation: PartialLocaleState = {
    ...
    strings: {
        ...
        "software.mohistneo.subtitle": "MohistNeo是一个出色的NeoForge服务器软件，实现了Bukkit、Spigot和Paper API。通过利用这个强大的组合，您可以创建一个高性能的Minecraft服务器，能够集成模组和插件，确保稳定性和最佳性能。",
        "software.mohistneo.cards.title": "MohistNeo有什么特别之处？",
        "software.mohistneo.cards.1.title": "增强性能",
        "software.mohistneo.cards.1.desc": "通过集成Bukkit和Spigot以支持插件，以及Paper以提高性能，即使有大量的模组和插件，也能享受流畅无缝的游戏体验。",
        "software.mohistneo.cards.2.title": "兼容性",
        "software.mohistneo.cards.2.desc": "通过MohistNeo与Bukkit、Spigot和Paper API的集成，解锁无限可能性的模组和插件兼容性。轻松定制您的服务器。",
