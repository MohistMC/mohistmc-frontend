...
const zhTranslation: PartialLocaleState = {
    ...
    strings: {
        ...
        "index.cards.mohistneo.description": "一个强大的Mohist NeoForge混合服务器软件，实现了Bukkit、Spigot API。",
        "index.cards.website.description": "我们的网站允许任何用户发现我们的软件并轻松免费下载它们!",
        "index.cards.other.description": "您不想询问上述3个软件中的任何一个吗？没问题，点击这里.",
        ...
        "software.mohist.subtitle": "Mohist是一个出色的Minecraft Forge服务器软件，实现了Bukkit、Spigot API。通过利用这个强大的组合，您可以创建一个高性能的Minecraft服务器，能够集成模组和插件，确保稳定性和最佳性能。",
        "software.mohist.cards.title": "Mohist有什么特别之处？",
        "software.mohist.cards.1.title": "增强性能",
        "software.mohist.cards.1.desc": "通过集成Bukkit和Spigot以支持插件和提高性能，即使有大量的模组和插件，也能享受流畅无缝的游戏体验。",
        "software.mohist.cards.2.title": "兼容性",
        "software.mohist.cards.2.desc": "通过Mohist与Bukkit、Spigot API的集成，解锁无限可能性的模组和插件兼容性。轻松定制您的服务器。",
        ...
        "software.mohistneo.title": "MohistNeo - 即将到来",
        "software.mohistneo.subtitle": "MohistNeo是一个出色的NeoForge服务器软件，实现了Bukkit、Spigot API。通过利用这个强大的组合，您可以创建一个高性能的Minecraft服务器，能够集成模组和插件，确保稳定性和最佳性能。",
        "software.mohistneo.cards.title": "MohistNeo有什么特别之处？",
        "software.mohistneo.cards.1.title": "增强性能",
        "software.mohistneo.cards.1.desc": "通过集成Bukkit和Spigot以支持插件和提高性能，即使有大量的模组和插件，也能享受流畅无缝的游戏体验。",
        "software.mohistneo.cards.2.title": "兼容性",
        "software.mohistneo.cards.2.desc": "通过MohistNeo与Bukkit、Spigot API的集成，解锁无限可能性的模组和插件兼容性。轻松定制您的服务器。",
        "software.mohistneo.cards.3.title": "社区支持和定期更新",
        "software.mohistneo.cards.3.desc": "加入MohistMC社区获取支持和定期更新！保持与最新的Minecraft版本同步，并获得新功能和改进。",
        "software.mohistneo.footer.title": "准备提升您的Minecraft服务器体验吗？",
        "software.mohistneo.footer.desc": "通过模组和插件的集成，以及优化的性能，体验无与伦比的稳定性。加入MohistMC社区，为您的服务器解锁无限可能性。立即升级到MohistNeo，革新您的Minecraft体验。",
        ...
        "report.issue.desc": "想要报告问题、提出问题或提出建议/功能请求？你来对地方了.",
        ...
        "report.issue.form.file.helper": "latest.log, crash-reports, screenshots, 或任何可以提供帮助的东西...",
