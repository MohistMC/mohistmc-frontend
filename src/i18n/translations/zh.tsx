...
const zhTranslation: PartialLocaleState = {
    ...
    strings: {
        ...
        "index.cards.mohist.description": "一个强大的Mohist Forge混合服务器软件，实现了Bukkit、Spigot和Paper API。",
        "index.cards.banner.description": "一个强大的Mohist Fabric混合服务器软件，实现了Bukkit和Spigot API。",
        ...
        "downloadSoftware.mohist.1.19.2.toast": "Mohist 1.19.2正在缓慢开发中，可能很快会停止维护。它可能存在错误。建议使用Mohist 1.19.4。",
        "downloadSoftware.mohist.1.19.4.toast": "Mohist 1.19.4目前处于开发阶段，可能存在错误。",
        "downloadSoftware.mohist.1.20.toast": "Mohist 1.20已停止维护，请使用Mohist 1.20.1以获取更新。",
        "downloadSoftware.mohist.1.20.1.toast": "Mohist 1.20.1目前处于开发阶段，可能存在错误。",
        ...
        "shop.cards.1.desc": "作为一个社区维护的项目，并且存在很多已发布的issues.",
        ...
        "shop.cards.3.title": "开发教学",
        "shop.cards.3.desc": "还在为昂贵的定制费用和开发者容易跑路发愁? 自己动手丰衣足食，从零学习如何写插件，如果魔改出你想要的功能。",
        "shop.cards.4.title": "周边售卖",
