...
const zhTranslation: PartialLocaleState = {
    ...
    strings: {
        ...
        "index.cards.youer.description": "一个强大的Mohist NeoForge混合服务器软件，实现了Bukkit、Spigot API。",
        ...
        "software.youer.subtitle": "Youer是一个出色的NeoForge服务器软件，实现了Bukkit、Spigot API。通过利用这个强大的组合，您可以创建一个高性能的Minecraft服务器，能够集成模组和插件，确保稳定性和最佳性能。",
        "software.youer.cards.title": "Youer有什么特别之处？",
        "software.youer.cards.1.title": "增强性能",
        "software.youer.cards.1.desc": "通过集成Bukkit和Spigot以支持插件和提高性能，即使有大量的模组和插件，也能享受流畅无缝的游戏体验。",
        "software.youer.cards.2.title": "兼容性",
        "software.youer.cards.2.desc": "通过Youer与Bukkit、Spigot API的集成，解锁无限可能性的模组和插件兼容性。轻松定制您的服务器。",
        "software.youer.cards.3.title": "社区支持和定期更新",
        "software.youer.cards.3.desc": "加入MohistMC社区获取支持和定期更新！保持与最新的Minecraft版本同步，并获得新功能和改进。",
        "software.youer.footer.title": "准备提升您的Minecraft服务器体验吗？",
        "software.youer.footer.desc": "通过模组和插件的集成，以及优化的性能，体验无与伦比的稳定性。加入MohistMC社区，为您的服务器解锁无限可能性。立即升级到Youer，革新您的Minecraft体验。",
