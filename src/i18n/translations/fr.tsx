...
const frTranslation: PartialLocaleState = {
    ...
    strings: {
        ...
        "index.cards.mohist.description": "Un puissant logiciel de serveur hybride Mohist Forge implémentant les API Bukkit, Spigot.",
        ...
        "downloads.mohist.desc": "Un logiciel de serveur Minecraft Forge implémentant les API Bukkit, Spigot. Avec ce logiciel, vous pouvez créer un serveur Minecraft avec des mods et des plugins ensemble !",
        ...
        "downloadSoftware.mohist.desc": "Téléchargez Mohist, notre logiciel de serveur Minecraft Forge implémentant les API Bukkit, Spigot.",
        ...
        "downloadSoftware.mohist.1.19.2.toast": "Mohist 1.19.2 est en développement lent et pourrait être bientôt abandonné. Il peut contenir des bugs.",
        "downloadSoftware.mohist.1.19.4.toast": "Mohist 1.19.4 a été interrompu, son utilisation n'est pas recommandée.",
        ...
        "software.mohist.subtitle": "Mohist est un logiciel serveur exceptionnel pour Minecraft Forge qui implémente les API Bukkit, Spigot. En exploitant cette puissante combinaison, vous pouvez créer un serveur Minecraft performant avec la capacité d'intégrer des mods et des plugins, garantissant ainsi stabilité et performances optimales.",
        "software.mohist.cards.title": "Qu'est ce qui rend %Mohist% si spécial ?",
        "software.mohist.cards.1.title": "Performance Améliorée",
        "software.mohist.cards.1.desc": "Avec l'intégration de Bukkit & Spigot pour la prise en charge des plugins et de performances, profitez d'une expérience de jeu fluide et sans problème, même avec une multitude de mods et de plugins.",
        "software.mohist.cards.2.title": "Compatibilité",
        "software.mohist.cards.2.desc": "Déverrouillez des possibilités infinies grâce à la compatibilité étendue des mods et des plugins avec Mohist. Personnalisez votre serveur facilement en utilisant l'intégration de Mohist avec les API Bukkit, Spigot.",
