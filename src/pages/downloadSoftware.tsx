            ...
            <div className="2xl:w-2/4 relative shadow-md sm:rounded-lg pt-20">
                <div className={`flex justify-between items-center pb-4 flex-wrap`}>
                    ...
                    <div id="dropdown"
                        ...
                        <ul className="py-2 text-sm text-gray-700 dark:text-gray-200"
                            ...
                            <li>
                                <Link href="#"
                                   className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">ver</Link>
                            </li>
                        </ul>
                    </div>
                </div>
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400 border-separate border-spacing-0 overflow-x-auto">
                    ...
                    <tr className="bg-white border-b dark:bg-dark-100 dark:border-gray-700">
                        ...
                        <td className="px-6 py-4 text-right">
                            <Link href="#"
                               className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Download</Link>
                        </td>
                        <td className="px-6 py-4 text-right">
                ...
                <nav className="flex items-center justify-between pt-4 flex-wrap" aria-label="Table navigation">
                    ...
                    <ul className="inline-flex items-center -space-x-px">
                        ...
                        <li>
                            <Link href="#"
                               className="px-3 py-2 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-dark-100 dark:border-dark-400 dark:text-gray-400 dark:hover:bg-dark-200 dark:hover:text-white">1</Link>
                        </li>
                        <li>
                            <Link href="#"
                               className="px-3 py-2 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-dark-100 dark:border-dark-400 dark:text-gray-400 dark:hover:bg-dark-200 dark:hover:text-white">2</Link>
                        </li>
                        <li>
                            <Link href="#" aria-current="page"
                               className="z-10 px-3 py-2 leading-tight text-blue-600 border border-blue-300 bg-blue-50 hover:bg-blue-100 hover:text-blue-700 dark:border-dark-400 dark:bg-dark-200 dark:text-white">3</Link>
                        </li>
                        <li>
                            <Link href="#"
                               className="px-3 py-2 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-dark-100 dark:border-dark-400 dark:text-gray-400 dark:hover:bg-dark-200 dark:hover:text-white">...</Link>
                        </li>
                        <li>
                            <Link href="#"
                               className="px-3 py-2 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-dark-100 dark:border-dark-400 dark:text-gray-400 dark:hover:bg-dark-200 dark:hover:text-white">100</Link>
                        </li>
                        <li>
                            <Link href="#"
