        ...
        <div className={`bg-white dark:bg-dark-25 flex flex-col`}>
            ...
            <section className="flex flex-col justify-center items-center pt-20 bg-white dark:bg-dark-25">
                <div className="pt-10 px-4 mx-auto max-w-screen-xl text-center">
                    ...
                    <p className="mb-12 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">{strings['mohistapi.subtitle']}</p>
                </div>
            </section>
            ...
            <Flowbite theme={{theme: customTheme, dark: isDark}}>
                <Toast>
                    ...
                    <div className="ml-3 text-sm font-normal text-gray-600 dark:text-gray-400">
                        Are you a developer/manager of a hosting service and wish to add one of our products to make it available to your users? <a href={`#`} onClick={() => setOpenHostModal('dismissible')} className="font-medium underline">Please read this note.</a>
                    </div>
                    <Toast.Toggle/>
                </Toast>
            </Flowbite>
