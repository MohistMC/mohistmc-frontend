...
export default function MohistMCApi() {
    ...
    return (
        <div className={`bg-white dark:bg-dark-25 flex flex-col`}>
            ...
            <NoteToHostsModal openHostModal={openHostModal} setOpenHostModal={setOpenHostModal}/>
            <section className="flex flex-col justify-center items-center pt-20 bg-white dark:bg-dark-25">
                <div className="pt-10 px-4 mx-auto max-w-screen-xl text-center">
                    <h1 className="text-center mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl lg:text-5xl dark:text-white">{getLocaleStringAsArgs(strings['mohistapi.title'])[0]}
                        <span
                            className="text-blue-600 dark:text-blue-500">{getLocaleStringAsArgs(strings['mohistapi.title'])[1]}</span>{getLocaleStringAsArgs(strings['mohistapi.title'])[2]}
                    </h1>
                ...
                <Flowbite theme={{theme: customTheme, mode}}>
                    <Toast>
                        ...
                        <div className="ml-3 text-sm font-normal text-gray-600 dark:text-gray-300">
                            Are you a developer/manager of a hosting service and wish to add one of our products to make
                            it available to your users? <a href={`#`} onClick={() => setOpenHostModal('dismissible')}
                                                           className="font-medium underline">Please read this note.</a>
                        </div>
                        <Toast.Toggle/>
                    </Toast>
                </Flowbite>
