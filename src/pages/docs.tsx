...
export default function Downloads() {
    ...
    return (
        <section className="flex flex-col justify-center items-center pt-20 pb-10 bg-white dark:bg-dark-25">
            ...
            <p className="mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-300 text-center">{strings['docs.subtitle']}</p>
            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 flex flex-row gap-4 flex-wrap">
                ...
                <Link href="/mohistmc-api" className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-dark-100 dark:border-dark-200 dark:hover:bg-dark-150">
                    <h2 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{strings['docs.cards.websiteapi.title']}</h2>
                    <p className="font-normal text-gray-700 dark:text-gray-300">{strings['docs.cards.websiteapi.desc']}</p>
                </Link>
            </div>
        </section>
