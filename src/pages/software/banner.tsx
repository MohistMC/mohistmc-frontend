        ...
        <div className="bg-white dark:bg-dark-25 pt-12">
            ...
            <section className="bg-white dark:bg-dark-25 pt-10">
                <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
                    <span className="bg-green-100 text-green-800 text-sm font-medium ml-0.5 h-6 w-16 px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300">
                        Beta
                    </span>
                    ...
                    <p className="mb-12 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-200 md:w-1/2">
                        {strings['software.banner.subtitle']}
                    </p>
            ...
            <section className={`bg-gray-100 dark:bg-dark-50`}>
                <h2 className="pt-10 md:pt-20 text-center text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-4xl dark:text-white">
                    {
                        getLocaleStringAsArgs(
                            strings['software.banner.cards.title'],
                        )[0]
                    }
                ...
                <div className="flex flex-wrap justify-center gap-12 w-full dark:bg-dark-50 pt-10 md:pt-20 md:pb-20 pb-10">
                    <div className="max-w-sm bg-gray-50 border border-gray-200 rounded-lg shadow dark:bg-dark-100 dark:border-dark-300 mr-5 ml-5">
                        ...
                        <div className="p-5">
                            <h2 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                                {strings['software.banner.cards.1.title']}
                            </h2>
                            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                                {strings['software.banner.cards.1.desc']}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="max-w-sm bg-gray-50 border border-gray-200 rounded-lg shadow dark:bg-dark-100 dark:border-dark-300 mr-5 ml-5">
                        ...
                        <div className="p-5">
                            <h2 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                                {strings['software.banner.cards.2.title']}
                            </h2>
                            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                                {strings['software.banner.cards.2.desc']}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="max-w-sm bg-gray-50 border border-gray-200 rounded-lg shadow dark:bg-dark-100 dark:border-dark-300 mr-5 ml-5">
                        ...
                        <div className="p-5">
                            <h2 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                                {strings['software.banner.cards.3.title']}
                            </h2>
                            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                                {strings['software.banner.cards.3.desc']}
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className={`pt-5 md:pt-10 pb-10`}>
                <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
                    <h2 className="mb-4 text-3xl font-extrabold tracking-tight leading-none text-gray-900 md:text-4xl lg:text-6xl dark:text-white">
                        {strings['software.mohist.footer.title']}
                    </h2>
                    <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">
                        {strings['software.banner.footer.desc']}
                    </p>
